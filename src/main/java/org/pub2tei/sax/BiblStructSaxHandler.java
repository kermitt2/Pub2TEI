    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("biblStruct")) {
            ...
            if (currentPerson != null) {
                ...
                if ( (currentPerson.getFirstName() == null) && (currentPerson.getMiddleName() == null) &&
                        (currentPerson.getLastName() == null) ) {
                    // we only have a raw name
                    biblioItem.setEditors(getText());
                } else 
